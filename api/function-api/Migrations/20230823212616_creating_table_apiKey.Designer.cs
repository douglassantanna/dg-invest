...
namespace function_api.Migrations
{
    ...
    [Migration("20230823212616_creating_table_apiKey")]
    partial class creating_table_apiKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("function_api.Auth.Models.ApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("function_api.Auth.Models.ApiKey", b =>
                {
                    b.HasOne("function_api.Users.Models.User", "User")
                        .WithOne("ApiKey")
                        .HasForeignKey("function_api.Auth.Models.ApiKey", "UserId")
