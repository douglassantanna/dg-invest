...
public sealed class FakeBybitService : IBybitService
{
    ...
    public List<BybitInternalTransferRow> InternalTransfers { get; } = [];
    ...
    public Task<List<BybitInternalTransferRow>> GetInternalTransferHistoryAsync(string apiKey, string apiSecret, BybitRegion region = BybitRegion.Global, int? limit = 50, long? startTime = null) => Task.FromResult(InternalTransfers);
